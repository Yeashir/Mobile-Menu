...
class ymm_Options_Framework_Media_Uploader {
	...
	public function init() {
		add_action( 'admin_enqueue_scripts', array( $this, 'ymm_optionsframework_media_scripts' ) );
	}
	...
	static function ymm_optionsframework_uploader( $_id, $_value, $_desc = '', $_name = '' ) {
	 ...
	 */
	function ymm_optionsframework_media_scripts( $hook ) {

		$menu = ymm_Options_Framework_Admin::menu_settings();
		...
		wp_register_script( 'of-media-uploader', ymm_OPTIONS_FRAMEWORK_DIRECTORY .'js/media-uploader.js', array( 'jquery' ), ymm_Options_Framework::VERSION );
		wp_enqueue_script( 'of-media-uploader' );
		wp_localize_script( 'of-media-uploader', 'ymm_optionsframework_l10n', array(
